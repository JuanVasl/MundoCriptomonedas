                ...
                <div class="card">
                    <form action="{{ route('save') }}" method="POST">
                        ...
                        <div class=" card-header text-center" style="background-color: #79dae8">
                            <h2 style="color: #2155cd"><i class="fas fa-user-check"></i> Registrar Cliente</h2>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg">
                                    <input type="text" class="form-control" value="{{old('id_cliente')}}"
                                           placeholder="Numero de pasaporte" name="id_cliente">
                                </div>

                                <div class="col-lg">
                                    <input type="text" name="nombre_persona" class="form-control"
                                           value="{{old('nombre_persona')}}" placeholder="Nombre del cliente">
                                </div>
